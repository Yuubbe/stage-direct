 ...
 */
final class Version20250427232330 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tbl_internship CHANGE created_by_id created_by_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `tbl_internship` CHANGE created_by_id created_by_id INT NOT NULL');
    }
}
